...
--alter table manufacturer drop column actve;
...
insert into manufacturer (id, name, location_id, averageYearlySales, foundedDate, active) values (1, 'Fender Musical Instruments Corporation', 3, 25000000, '1946-01-01', false);
insert into manufacturer (id, name, location_id, averageYearlySales, foundedDate, active) values (2, 'Gibson Guitar Corporation', 42, 32000000, '1902-01-01', true);
